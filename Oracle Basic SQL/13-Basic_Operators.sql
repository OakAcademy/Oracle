--##############################################################
-- Hi dear friends, This file is about basic operators 
-- that you can use in SELECT statement on oracle database
...
--------- EXAMPLES ----------------------------------------------
	...
	--dual table example 
	select 'This is a column' col1, 'this is another column' col2 from dual


	-- total example for single row operators
	...
	salary - 100 salary_subtracted_100,
	salary || ' $ earns' salary_concatenated
	from employee
